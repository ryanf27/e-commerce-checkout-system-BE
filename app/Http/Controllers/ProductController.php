...
class ProductController extends Controller
{
    ...
    {
        try {
            $data['products'] = DB::table('products')->leftJoin('categories', 'categories_id', '=', 'products.category_id')->select(['products.*', 'categories.name as category'])->get();
    ...
    public function show(string $id)
    {
        try {
            ...
            return $this->sendResponse('product fetch succesfully', $data, 200);
        } catch (\Exception $e) {
            return $this->handleException($e);
        }
    }
